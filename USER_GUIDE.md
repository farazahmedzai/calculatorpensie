# CalculatorPensie.com - Ghidul Utilizatorului

## Bun Venit la Romania's #1 Calculator de Pensie

### Ce este CalculatorPensie.com?
CalculatorPensie.com este platforma de calcul pensii cel mai rapidă, cel mai ușor de folosit și cel mai cuprinzătoare din România. Oferim estimări gratuite, instantanee și precise pentru pensia de stat (Pilon I) și vârsta de pensionare, prezentate într-o interfață curată, modernă și de încredere.

### Problema Ta: Sistemul Complex de Pensii
Dacă ești român cu vârsta între 30-65 ani și te simți confuz de sistemul oficial complex de pensii, nu ești singur. Nu știi data exactă de pensionare sau cât va fi pensia ta estimată. Ești îngrijorat pentru viitorul tău financiar.

### Soluția Noastră: Claritate Instantanee
Oferim claritate instantanee și liniște sufletească cu un instrument simplu. Tonul întregii pagini este liniștitor, profesional și ușor de înțeles.

### Caracteristici Principale
- **Calculator Principal de Pensie**: Calculează pensia standard de pensionare
- **Calculator Pensie Anticipată**: Explorează opțiunile de pensionare timpurie  
- **Calculator Pilonul III**: Planifică contribuțiile la pensia privată
- **Ghiduri Educaționale**: Învață despre sistemul românesc de pensii
- **Știri Recente**: Rămâi la curent cu schimbările în legea pensiilor

## Folosirea Calculatoarelor

### Calculator Principal de Pensie (Above-the-Fold)
**Locația**: Homepage - vizibil imediat sub H1, fără să faci scroll

**Informații Necesare (Câmpuri Obligatorii)**:
1. **Data Nașterii**: Selectează din calendarul drop-down
2. **Sex**: Alege Bărbat sau Femeie (cruciale - vârstele de pensionare diferă)
3. **Salariu Brut Lunar Actual (RON)**: Introdu suma în Lei cu tooltip (?) pentru explicații
4. **Stagiu de Cotizare Actual (Ani)**: Numărul de ani lucrați cu contract cu tooltip "Câți ani ai lucrat cu contract de muncă până acum?"
5. **Condiții de Muncă**: Alege din dropdown - Normale, Deosebite, Speciale (poate reduce vârsta de pensionare)

**Cum să Folosești**:
1. Selectează data nașterii din calendarul interactiv
2. Alege sexul (afectează vârsta minimă de pensionare)  
3. Introdu salariul brut lunar în Lei
4. Specifică anii de cotizare până acum
5. Selectează condițiile de muncă
6. **Rezultatele apar instantaneu** după completarea ultimului câmp
...
- **Fără Stocare Date**: Nu stocăm permanent datele personale introduse în calculator
- **Calcule Locale**: Calculele se efectuează local în browser-ul tău
- **Conexiune Sigură**: Conexiune HTTPS securizată
- **Fără Înregistrare**: Nu este necesară înregistrarea pentru funcțiile de bază
- **Transparență**: Consultă Politica de Confidențialitate pentru detalii complete
...
**Î: Pot salva calculele mele?**
R: Momentan, calculele nu sunt salvate. Recomandăm să faci capturi de ecran sau să notezi rezultatele.
...
**Î: Unde pot vedea stagiul meu de cotizare oficial?**
R: Poți verifica stagiul de cotizare exact creând un cont online pe portalul Casei Naționale de Pensii Publice (CNPP.ro) sau vizitând o casă teritorială de pensii.
