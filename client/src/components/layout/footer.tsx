        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-2">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold">CalculatorPensie.ro</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Platforma de referință pentru calculul și planificarea pensiilor în România. 
              Calculatoare precise, ghiduri complete și informații actualizate conform legislației în vigoare.
            </p>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-300 text-sm mb-4 md:mb-0">
              <p>&copy; 2024 CalculatorPensie.ro. Toate drepturile rezervate.</p>
              <p className="mt-1">Actualizat conform legislației în vigoare din România.</p>
            </div>
            <div className="flex space-x-6 text-sm text-gray-300">
              <Link href="/termeni-conditii">
                <a className="hover:text-white transition-colors">Termeni și Condiții</a>
              </Link>
